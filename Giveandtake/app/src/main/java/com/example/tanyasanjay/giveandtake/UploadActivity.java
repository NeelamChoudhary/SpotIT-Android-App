...
public class UploadActivity extends ListActivity {
    ...
    ArrayList<String> image, video; //neelam
    String sessionToken = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video = new ArrayList<String>(); //neelam
        ...
        save.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent navIntent = new Intent(UploadActivity.this, Nav.class);
                navIntent.putExtra("sessionToken",sessionToken);
    ...
    private void beginUpload(String filePath) {
        ...
        Log.d("beginUpload", file.getName());
        TransferObserver observer = transferUtility.upload(Constants.BUCKET_NAME, file.getName(),
                file);

        if(filePath.endsWith(".mp4")) //neelam
    ...
    public void postlDetail(String tablename) throws JSONException, UnsupportedEncodingException {
        ...
        for (int i = 0; i < image.size(); i++) {
            imageArray.put(image.get(i));
        }
        json.put("itemImage", imageArray);

        //neelam temp starts
        JSONArray videoArray = new JSONArray();
        for (int i = 0; i < video.size(); i++) {
            videoArray.put(video.get(i));
        }
        json.put("itemVideo", videoArray);

        Log.d("Details itemVideo", json.toString());
