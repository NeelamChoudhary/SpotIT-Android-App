...
import com.example.tanyasanjay.giveandtake.SampleApplication.utils.SampleMath;
import com.example.tanyasanjay.giveandtake.SampleApplication.utils.SampleUtils;
...
import com.example.tanyasanjay.giveandtake.VideoPlayback.app.VideoPlayback.VideoPlayerHelper.MEDIA_TYPE;
...
public class VideoPlaybackRenderer implements GLSurfaceView.Renderer
{
    ...
    void renderFrame()
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            if ((currentStatus[currentTarget] == MEDIA_STATE.READY)
                || (currentStatus[currentTarget] == MEDIA_STATE.REACHED_END)
                || (currentStatus[currentTarget] == MEDIA_STATE.PAUSED)
                || (currentStatus[currentTarget] == MEDIA_STATE.NOT_READY)
                || (currentStatus[currentTarget] == MEDIA_STATE.ERROR))
            {
